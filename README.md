...
getgenv()['Check_Setting'] = function(Name)
    if not _G.Dis and not isfolder('Zoom Hub BF Premium') then
        makefolder('Zoom Hub BF Premium')
    end
    if not _G.Dis and not isfile('Zoom Hub BF Premium/'..Name..'.json') then
        writefile('Zoom Hub BF Premium/'..Name..'.json',JsonEncode(_G.Setting_table))
    end
end
getgenv()['Get_Setting'] = function(Name)
    if not _G.Dis and isfolder('Zoom Hub BF Premium') and isfile('Zoom Hub BF Premium/'..Name..'.json') then
        _G.Setting_table = JsonDecode(readfile('Zoom Hub BF Premium/'..Name..'.json'))
...
game.StarterGui:SetCore("SendNotification", {
	Title = "Zoom Notification", 
	Text = "ฟังชั่นสามารถเปิด\nพร้อมฟามเวลได้",
	Icon = "http://www.roblox.com/asset/?id=9610159123",
	Duration = 8
})

local win = library:Window("Zoom",[[Hub]],[[Version : Premium ]],"9606070311",Enum.KeyCode.RightControl)
...
Quest_Tab:Toggle("Auto Mink Evo V0 - V2","9606294253",_G.Setting_table.Mink_Evo,function(vu)
